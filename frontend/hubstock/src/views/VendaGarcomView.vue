...
const drawerWidth = ref(window.innerWidth > 1000 ? 500 : '100%');
...
const finalizeMesaSale = async () => {
    ...
    // GARÇOM logado é o responsável pela venda
...
@media (max-width: 767px) {
    ...
    .mesas-grid {
        grid-template-columns: repeat(auto-fit, minmax(80px, 1fr)); /* Novo */
        gap: 10px;
        margin-bottom: 20px;
    }
